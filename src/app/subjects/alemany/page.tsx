...
export const metadata: Metadata = {
  title: 'Alemany | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Alemany per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function AlemanyPage() {
  const asignaturaId = 'alemany';
