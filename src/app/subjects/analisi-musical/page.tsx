...
export const metadata: Metadata = {
  title: 'Anàlisi musical | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Anàlisi musical per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function AnalisiMusicalPage() {
  const asignaturaId = 'analisi-musical';
