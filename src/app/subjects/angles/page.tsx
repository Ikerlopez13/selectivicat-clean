...
export const metadata: Metadata = {
  title: 'Anglès | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Anglès per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
