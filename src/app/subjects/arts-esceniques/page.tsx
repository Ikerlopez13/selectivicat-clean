...
export const metadata: Metadata = {
  title: 'Arts Escèniques | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Arts Escèniques per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function ArtsEsceniquesPage() {
  const asignaturaId = 'arts-esceniques';
