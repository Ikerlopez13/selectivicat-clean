...
export const metadata: Metadata = {
  title: 'Biologia | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Biologia per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
