...
export const metadata: Metadata = {
  title: 'Llengua Castellana i Literatura | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Llengua Castellana i Literatura per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
