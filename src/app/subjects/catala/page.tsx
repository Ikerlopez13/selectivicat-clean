...
export const metadata: Metadata = {
  title: 'Llengua Catalana i Literatura | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Llengua Catalana i Literatura per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function CatalaPage() {
  const asignaturaId = 'catala';
