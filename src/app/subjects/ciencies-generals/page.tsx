...
export const metadata: Metadata = {
  title: 'Ciències Generals | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Ciències Generals per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function CienciesGeneralsPage() {
  const asignaturaId = 'ciencies-generals';
