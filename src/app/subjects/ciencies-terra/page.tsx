...
export const metadata: Metadata = {
  title: 'Ciències de la terra | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Ciències de la terra per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function CienciesTerraPage() {
  const asignaturaId = 'ciencies-terra';
