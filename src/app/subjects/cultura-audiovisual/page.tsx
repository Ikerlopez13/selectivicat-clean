...
export const metadata: Metadata = {
  title: 'Cultura Audiovisual | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Cultura Audiovisual per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function CulturaAudiovisualPage() {
  const asignaturaId = 'cultura-audiovisual';
