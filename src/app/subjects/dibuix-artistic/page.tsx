...
export const metadata: Metadata = {
  title: 'Dibuix artístic | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Dibuix artístic per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function DibuixArtisticPage() {
  const asignaturaId = 'dibuix-artistic';
