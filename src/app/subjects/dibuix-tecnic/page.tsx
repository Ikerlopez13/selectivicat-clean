...
export const metadata: Metadata = {
  title: 'Dibuix tècnic | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Dibuix tècnic per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function DibuixTecnicPage() {
  const asignaturaId = 'dibuix-tecnic';
