...
export const metadata: Metadata = {
  title: 'Disseny | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Disseny per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function DissenyPage() {
  const asignaturaId = 'disseny';
