...
export const metadata: Metadata = {
  title: 'Economia | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Economia per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
