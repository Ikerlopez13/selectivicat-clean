...
export const metadata: Metadata = {
  title: 'Electrotècnia | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Electrotècnia per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function ElectrotecniaPage() {
  const asignaturaId = 'electrotecnia';
