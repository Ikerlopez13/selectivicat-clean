...
export const metadata: Metadata = {
  title: 'Empresa | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Empresa per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
