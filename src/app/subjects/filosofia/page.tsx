...
export const metadata: Metadata = {
  title: 'Filosofia | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Filosofia per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
