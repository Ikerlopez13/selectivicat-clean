...
export const metadata: Metadata = {
  title: 'Física | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Física per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
