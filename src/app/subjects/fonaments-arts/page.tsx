...
export const metadata: Metadata = {
  title: 'Fonaments de les arts | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Fonaments de les arts per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function FonamentsArtsPage() {
  const asignaturaId = 'fonaments-arts';
