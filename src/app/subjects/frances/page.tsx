...
export const metadata: Metadata = {
  title: 'Francès | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Francès per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
