...
export const metadata: Metadata = {
  title: 'Geografia | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Geografia per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
