...
export const metadata: Metadata = {
  title: 'Grec | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Grec per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
