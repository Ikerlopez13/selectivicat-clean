...
export const metadata: Metadata = {
  title: 'Història de la Filosofia | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Història de la Filosofia per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function HistoriaFilosofiaPage() {
  const asignaturaId = 'historia-filosofia';
