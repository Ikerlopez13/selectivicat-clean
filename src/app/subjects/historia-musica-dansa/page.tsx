...
export const metadata: Metadata = {
  title: 'Història de la Música i de la Dansa | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Història de la Música i de la Dansa per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function HistoriaMusicaDansaPage() {
  const asignaturaId = 'historia-musica-dansa';
