...
export const metadata: Metadata = {
  title: 'Història | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Història per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function HistoriaPage() {
  ...
  // Filtrar videos directamente
  const historiaVideos = videos.filter(video => video.subjectId === 'historia');
