...
export const metadata: Metadata = {
  title: 'Italià | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Italià per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
