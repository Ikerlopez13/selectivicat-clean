...
export const metadata: Metadata = {
  title: 'Llatí | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Llatí per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function LlatiPage() {
  const asignaturaId = 'llati';
