...
export const metadata: Metadata = {
  title: 'Matemàtiques CCSS | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Matemàtiques CCSS per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function MatematiquesCcssPage() {
  const asignaturaId = 'matematiques-ccss';
