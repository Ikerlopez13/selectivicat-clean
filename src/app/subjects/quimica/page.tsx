...
export const metadata: Metadata = {
  title: 'Química | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Química per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
