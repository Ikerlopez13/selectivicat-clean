...
export const metadata: Metadata = {
  title: 'Tecnologia Industrial | SelectiviCat',
  description: 'Recursos, vídeos i exàmens de Tecnologia Industrial per a la selectivitat. Prepara\'t per a les PAU amb els millors materials.',
};
...
export default function TecnologiaIndustrialPage() {
  const asignaturaId = 'tecnologia-industrial';
